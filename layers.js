...
lyr_GOOGLE1_0.setVisible(true);lyr_SYN_MONAD_1.setVisible(true);lyr_APOSTASEIS_2.setVisible(true);lyr_TR_IX_3.setVisible(true);lyr_TRAD_4.setVisible(true);lyr_TRMMM_5.setVisible(true);lyr_TRTAXI_6.setVisible(true);lyr_TRUnknown_7.setVisible(true);lyr_NO_DOC_8.setVisible(true);lyr_GEKY_50Km_9.setVisible(true);lyr_GEKY1050Km_10.setVisible(true);lyr_GEKY_10Km_11.setVisible(true);lyr_HOSPNPS_50Km_12.setVisible(true);lyr_HOSPNPS_1050Km_13.setVisible(true);lyr_HOSPNPS_10Km_14.setVisible(true);lyr_MD_XDOC_15.setVisible(true);lyr_MD_50Km_16.setVisible(true);lyr_MD1050km_17.setVisible(true);lyr_MD_10km_18.setVisible(true);
var layersList = [lyr_GOOGLE1_0,lyr_SYN_MONAD_1,lyr_APOSTASEIS_2,lyr_TR_IX_3,lyr_TRAD_4,lyr_TRMMM_5,lyr_TRTAXI_6,lyr_TRUnknown_7,lyr_NO_DOC_8,lyr_GEKY_50Km_9,lyr_GEKY1050Km_10,lyr_GEKY_10Km_11,lyr_HOSPNPS_50Km_12,lyr_HOSPNPS_1050Km_13,lyr_HOSPNPS_10Km_14,lyr_MD_XDOC_15,lyr_MD_50Km_16,lyr_MD1050km_17,lyr_MD_10km_18];
...
lyr_MD_10km_18.set('fieldLabels', {'fid': 'no label', 'C_PATIENTS': 'no label', 'X': 'header label - visible with data', 'Y': 'no label', 'C_DOC': 'no label', 'X1': 'no label', 'Y1': 'no label', 'K': 'no label', 'Color': 'no label', 'Shape': 'no label', 'Borders': 'no label', });
