...
lyr_MD_10km_19.set('fieldLabels', {'fid': 'no label', 'C_PATIENTS': 'no label', 'X': 'no label', 'Y': 'no label', 'C_DOC': 'no label', 'X1': 'no label', 'Y1': 'no label', 'K': 'no label', 'Color': 'no label', 'Shape': 'no label', 'Borders': 'no label', });
